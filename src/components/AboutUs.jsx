...
const AboutUs = () => {
  return (
    <>
      <div className="bg_about bg-center bg-cover">
        <div className="max-w-[1140px] mx-auto px-3 sm:my-[60px] my-[48px] lg:my-[100px] md:my-[80px] xl:mt-[218px] xl:mb-[130px] relative">
          <img
            className="sm:block hidden absolute max-w-[100px] xl:max-w-[160px] end-0 xl:end-[-12%] bottom-0"
            src={spax}
            alt="spax"
          />
          <div className="flex items-center justify-between gap-6 md:gap-0 md:flex-row flex-col">
            <div className="xl:ms-[-14%] relative">
              ...
              <p className="font-black font-grandstander text-[20px] sm:text-[25px] lg:text-[32px] text-[#757575] xl:ms-[21%] absolute sm:block hidden bottom-[10%] md:bottom-[-18%] start-[-5%] md:start-[15%]">
                I love FUDing
              </p>
              <p className="font-black font-grandstander text-[20px] sm:text-[25px] lg:text-[32px] text-[#757575] xl:ms-[23%] rotate-[-20deg] absolute bottom-[10%] md:bottom-[18%] end-0 sm:end-[5%] md:end-[0%]">
                I love FUDing
              </p>
            ...
            <div className="flex flex-col lg:ps-4 xl:ps-[59px]">
              ...
              <div className="lg:mt-5 mt-2 ps-2 xl:ps-3">
                <h2 className="text-black text-xl xl:text-2xl font-inter leading-full font-black">
                  ABOUT US
                </h2>
                <p className="text-[#333333] md:max-w-[550px] leading-[156%] pt-0 lg:pt-5 text-[12px]  lg:text-base font-inter">
                ...
                <p className="text-[#333333] md:max-w-[550px] pt-2 leading-[156%] lg:pt-[17px] text-[12px]  lg:text-base font-inter">
                ...
                <p className="text-[#333333] md:max-w-[560px] text-[12px] leading-[156%] lg:text-base pt-2 lg:pt-[17px] font-inter">
                ...
                <p className="text-[#333333] md:max-w-[580px] text-[12px] leading-[156%] lg:text-base pt-2 lg:pt-[17px] font-inter">
